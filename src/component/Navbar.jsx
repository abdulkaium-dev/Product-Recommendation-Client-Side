  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 w-full z-50 bg-indigo-50 dark:bg-indigo-900 shadow-md">
        <div className="max-w-screen-xl mx-auto px-3 sm:px-3 lg:px-6">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-3 whitespace-nowrap overflow-hidden">
              ...
              <span
                className="text-2xl font-bold text-indigo-600 dark:text-indigo-200"
                style={{ display: "inline-block", minWidth: "220px" }} // Fixed width to prevent jumping
              >
                {text}
                <Cursor cursorStyle="|" />
              </span>
        ...
        {/* Mobile Menu */}
        {isOpen && (
          <div className="md:hidden px-6 pb-6 border-t border-indigo-200 dark:border-indigo-700 bg-indigo-50 dark:bg-indigo-900 transition-all duration-300 ease-in-out">
